...
import { getDashboardStats , getTeamPerformance ,getSourcePerformance, getMyDashboard, getMyRecentFollowups, getMyMonthlyTrend, getTodayFollowups, getTodaySchedules, getMyDailyActivity, getManagerSummary} from "../../controllers/dashboard/dashboardController";
...
router.get("/today-schedules",protect,getTodaySchedules);
router.get("/my-daily-activity",protect,getMyDailyActivity);
